...
$personalAccessTokenName="google" 
$personalAccessTokenSecret="J46AaismTxmuutp7WzF8dA==:TMJ4cWShqQpBgmFg1goSg7FheXnLJG4k" 
...
function func_TableauSignin {param($site)
                        ...
                        $ts_body = "<tsRequest>`n	<credentials`n	  personalAccessTokenName=`"$personalAccessTokenName`" personalAccessTokenSecret=`"$personalAccessTokenSecret`" >`n  		<site contentUrl=`"$site`" />`n	</credentials>`n</tsRequest>"
